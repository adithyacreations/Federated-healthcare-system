...
from .views import (
    ...
    ReportWrongProductView,
    ResolveOrderIssueView,
    ListCreatePharmacyDriverView,
...
urlpatterns = [
    ...
    path('orders/<uuid:order_id>/report-issue/', ReportWrongProductView.as_view()),
    path('orders/<uuid:order_id>/resolve-issue/', ResolveOrderIssueView.as_view()),
    ...
    path('drivers/', ListCreatePharmacyDriverView.as_view()),
    ...
    path('monthly-report/', PharmacyMonthlyReportView.as_view()),
]
